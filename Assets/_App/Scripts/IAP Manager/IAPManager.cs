...
public class Key
{
    public const string PACK1 = "app37_pack1";
    public const string PACK2 = "app37_pack2";
    public const string PACK3 = "app37_pack3";
    public const string PACK4 = "app37_pack4";


    public const string PACK1_REGISTER = "register_app37_pack1";
    public const string PACK2_REGISTER = "register_app37_pack2";
    public const string PACK3_REGISTER = "register_app37_pack3";
    public const string PACK4_REGISTER = "register_app37_pack4";
    public const string PACK5_REGISTER = "register_app37_pack5";
}
